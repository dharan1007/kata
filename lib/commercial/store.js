...
export const COMMERCIAL_STORE_METHODS=Object.freeze([
  'transaction','getUserBySubject','insertUser','findPersonalOrganizationForUser','insertOrganization','insertMembership','getMembership','listMembershipsForUpdate','updateMembershipRole','deleteMembership','listOrganizationsForUser','insertInvitation','getInvitationByHashForUpdate','getInvitationById','markInvitationAccepted','markInvitationRevoked','insertProject','getProject','listProjectsForUser','insertEnvironment','insertApiKey','getApiKeyByPrefix','getApiKeyById','revokeApiKey','touchApiKey','listApiKeysForOrganization','appendAuditEvent'
]);
