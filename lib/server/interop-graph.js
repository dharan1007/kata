...
export function buildInteropGraph(environment={}){
  ...
  if(e.botProtection==='challenge'||e.botProtection==='blocked'){
    ...
    applyScopedRestriction(paths,e.botProtectionScope,'BOT_CHALLENGE',{browserStatus:status,serverStatus:status,reason:'An anti-automation control is active and must not be bypassed.'});
  }
