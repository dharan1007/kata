...
const assets=['index.html','style.css','favicon.svg','robots.txt','src/main.js','src/app.js','src/webmcp.js','src/runtime-probe.js','src/api-discovery.js','src/api-adapter.js','src/api-execution.js','lib/shared/tool-contracts.js','lib/shared/schema.js'];
