...
function operationBaseUrl(discovery,operation){const description=descriptionFor(discovery,operation);if(!description)return null;const raw=Array.isArray(description.servers)&&description.servers.length?description.servers[0]:'/';if(typeof raw!=='string'||raw.includes('{'))return null;return safeHttpUrl(raw,description.url);}
